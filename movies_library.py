...
def sort_by_amount_plays_desc(elems_libraries):
    top_popular_content = sorted(
        elems_libraries, key=lambda elem: elem.amount_plays, reverse=True)
    return top_popular_content
...
if __name__ == "__main__":
    ...
    top_popular_content = top_titles(movies_and_series=movies_and_series,
                                     amount_chose_movies_and_series=3, content_type=2)
